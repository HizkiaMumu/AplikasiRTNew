            ...
            <div class="auth-form">
                <div class="card my-5 mx-3">
                    <div class="card-body">
                        ...
                        <p class="mb-3">Belum punya akun? <a href="/register" class="link-primary ms-1">Klik Disini</a>
                        </p>
                        @if(session('ERR'))
                        ...
                        <form action="/login" method="POST">
                          {{ csrf_field() }}
                          <div class="mb-3">
                              <input type="text" name="nik" class="form-control" id="floatingInput" placeholder="NIK" />
                          </div>
                          <div class="mb-3">
