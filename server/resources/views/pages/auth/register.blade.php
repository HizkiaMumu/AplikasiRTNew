        ...
        <div class="auth-wrapper">
            <div class="auth-sidecontent">
                <div class="auth-sidefooter">
                    ...
                    <div class="row">
                        <div class="col my-1">
                            <p class="m-0">Made with ♥ by Team<a href="https://mudamudiworks.com" target="_blank"></a>
                            </p>
                        </div>
            ...
            <div class="auth-form">
                <div class="card my-5 mx-3">
                    <div class="card-body">
                        <h4 class="f-w-500 mb-1">Halo, Selamat Datang 👋</h4>
                        <p class="mb-3">Sudah punya akun? <a href="/login" class="link-primary">Klik Disini</a></p>
                        @if(session('ERR'))
                        ...
                        <form action="/register" method="POST">
                            ...
                            <div class="mb-3">
                                <input type="text" name="phone_number" class="form-control" placeholder="Nomor Telp">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <input type="text" name="tempat_tanggal_lahir" class="form-control" placeholder="Tempat, Tanggal Lahir (Contoh: Jakarta, 01-01-2000)">
                            </div>
                            ...
                            <div class="d-flex mt-1 justify-content-between">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label text-muted" for="customCheckc1">Saya menyetujui semua
                                        Syarat & Ketuntuan yang ada</label>
                                </div>
                            </div>
